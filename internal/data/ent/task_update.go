...
func (_u *TaskUpdate) SetModuleID(v string) *TaskUpdate {
	_u.mutation.SetModuleID(v)
	return _u
}

// SetNillableModuleID sets the "module_id" field if the given value is not nil.
func (_u *TaskUpdate) SetNillableModuleID(v *string) *TaskUpdate {
	if v != nil {
		_u.SetModuleID(*v)
	}
	return _u
...
func (_u *TaskUpdate) ClearModuleID() *TaskUpdate {
...
func (_u *TaskUpdate) SetTaskOptions(v *schedulerpb.TaskOption) *TaskUpdate {
...
func (_u *TaskUpdate) SetLastRunAt(v time.Time) *TaskUpdate {
	_u.mutation.SetLastRunAt(v)
	return _u
}

// SetNillableLastRunAt sets the "last_run_at" field if the given value is not nil.
func (_u *TaskUpdate) SetNillableLastRunAt(v *time.Time) *TaskUpdate {
	if v != nil {
		_u.SetLastRunAt(*v)
	}
	return _u
...
func (_u *TaskUpdate) ClearLastRunStatus() *TaskUpdate {
	_u.mutation.ClearLastRunStatus()
	return _u
}

// SetLastRunMessage sets the "last_run_message" field.
func (_u *TaskUpdate) SetLastRunMessage(v string) *TaskUpdate {
	_u.mutation.SetLastRunMessage(v)
	return _u
}

// SetNillableLastRunMessage sets the "last_run_message" field if the given value is not nil.
func (_u *TaskUpdate) SetNillableLastRunMessage(v *string) *TaskUpdate {
	if v != nil {
		_u.SetLastRunMessage(*v)
	}
	return _u
}

// ClearLastRunMessage clears the value of the "last_run_message" field.
func (_u *TaskUpdate) ClearLastRunMessage() *TaskUpdate {
	_u.mutation.ClearLastRunMessage()
	return _u
}

// SetRunCount sets the "run_count" field.
func (_u *TaskUpdate) SetRunCount(v int32) *TaskUpdate {
...
func (_u *TaskUpdate) SetNillableRunCount(v *int32) *TaskUpdate {
	if v != nil {
		_u.SetRunCount(*v)
	}
	return _u
...
func (_u *TaskUpdate) AddRunCount(v int32) *TaskUpdate {
...
func (_u *TaskUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.ModuleIDCleared() {
		_spec.ClearField(task.FieldModuleID, field.TypeString)
	}
	...
	if _u.mutation.LastRunAtCleared() {
		_spec.ClearField(task.FieldLastRunAt, field.TypeTime)
	}
	...
	if _u.mutation.LastRunStatusCleared() {
		_spec.ClearField(task.FieldLastRunStatus, field.TypeString)
	}
	if value, ok := _u.mutation.LastRunMessage(); ok {
		_spec.SetField(task.FieldLastRunMessage, field.TypeString, value)
	}
	if _u.mutation.LastRunMessageCleared() {
		_spec.ClearField(task.FieldLastRunMessage, field.TypeString)
	}
	...
	if value, ok := _u.mutation.AddedRunCount(); ok {
		_spec.AddField(task.FieldRunCount, field.TypeInt32, value)
	}
...
// SetModuleID sets the "module_id" field.
func (_u *TaskUpdateOne) SetModuleID(v string) *TaskUpdateOne {
	_u.mutation.SetModuleID(v)
	return _u
}

// SetNillableModuleID sets the "module_id" field if the given value is not nil.
func (_u *TaskUpdateOne) SetNillableModuleID(v *string) *TaskUpdateOne {
	if v != nil {
		_u.SetModuleID(*v)
	}
	return _u
...
// ClearModuleID clears the value of the "module_id" field.
func (_u *TaskUpdateOne) ClearModuleID() *TaskUpdateOne {
	_u.mutation.ClearModuleID()
	return _u
}
...
// SetTaskOptions sets the "task_options" field.
func (_u *TaskUpdateOne) SetTaskOptions(v *schedulerpb.TaskOption) *TaskUpdateOne {
	_u.mutation.SetTaskOptions(v)
	return _u
}
...
// SetLastRunAt sets the "last_run_at" field.
func (_u *TaskUpdateOne) SetLastRunAt(v time.Time) *TaskUpdateOne {
	_u.mutation.SetLastRunAt(v)
	return _u
}

// SetNillableLastRunAt sets the "last_run_at" field if the given value is not nil.
func (_u *TaskUpdateOne) SetNillableLastRunAt(v *time.Time) *TaskUpdateOne {
	if v != nil {
		_u.SetLastRunAt(*v)
	}
	return _u
...
// ClearLastRunAt clears the value of the "last_run_at" field.
func (_u *TaskUpdateOne) ClearLastRunAt() *TaskUpdateOne {
	_u.mutation.ClearLastRunAt()
	return _u
}

// SetLastRunStatus sets the "last_run_status" field.
func (_u *TaskUpdateOne) SetLastRunStatus(v string) *TaskUpdateOne {
	_u.mutation.SetLastRunStatus(v)
	return _u
}

// SetNillableLastRunStatus sets the "last_run_status" field if the given value is not nil.
func (_u *TaskUpdateOne) SetNillableLastRunStatus(v *string) *TaskUpdateOne {
	if v != nil {
		_u.SetLastRunStatus(*v)
	}
	return _u
...
// ClearLastRunStatus clears the value of the "last_run_status" field.
func (_u *TaskUpdateOne) ClearLastRunStatus() *TaskUpdateOne {
	_u.mutation.ClearLastRunStatus()
	return _u
}

// SetLastRunMessage sets the "last_run_message" field.
func (_u *TaskUpdateOne) SetLastRunMessage(v string) *TaskUpdateOne {
	_u.mutation.SetLastRunMessage(v)
	return _u
}

// SetNillableLastRunMessage sets the "last_run_message" field if the given value is not nil.
func (_u *TaskUpdateOne) SetNillableLastRunMessage(v *string) *TaskUpdateOne {
	if v != nil {
		_u.SetLastRunMessage(*v)
	}
	return _u
...
// ClearLastRunMessage clears the value of the "last_run_message" field.
func (_u *TaskUpdateOne) ClearLastRunMessage() *TaskUpdateOne {
	_u.mutation.ClearLastRunMessage()
	return _u
}

// SetRunCount sets the "run_count" field.
func (_u *TaskUpdateOne) SetRunCount(v int32) *TaskUpdateOne {
	_u.mutation.ResetRunCount()
	_u.mutation.SetRunCount(v)
	return _u
}
...
// SetNillableRunCount sets the "run_count" field if the given value is not nil.
func (_u *TaskUpdateOne) SetNillableRunCount(v *int32) *TaskUpdateOne {
	if v != nil {
		_u.SetRunCount(*v)
	}
	return _u
...
// AddRunCount adds value to the "run_count" field.
func (_u *TaskUpdateOne) AddRunCount(v int32) *TaskUpdateOne {
	_u.mutation.AddRunCount(v)
	return _u
}

...
func (_c *TaskCreate) SetModuleID(v string) *TaskCreate {
	_c.mutation.SetModuleID(v)
	return _c
}

// SetNillableModuleID sets the "module_id" field if the given value is not nil.
func (_c *TaskCreate) SetNillableModuleID(v *string) *TaskCreate {
	if v != nil {
		_c.SetModuleID(*v)
	}
	return _c
...
func (_c *TaskCreate) SetTaskOptions(v *schedulerpb.TaskOption) *TaskCreate {
...
func (_c *TaskCreate) SetLastRunAt(v time.Time) *TaskCreate {
	_c.mutation.SetLastRunAt(v)
	return _c
}

// SetNillableLastRunAt sets the "last_run_at" field if the given value is not nil.
func (_c *TaskCreate) SetNillableLastRunAt(v *time.Time) *TaskCreate {
	if v != nil {
		_c.SetLastRunAt(*v)
	}
	return _c
...
func (_c *TaskCreate) SetLastRunStatus(v string) *TaskCreate {
	_c.mutation.SetLastRunStatus(v)
	return _c
}

// SetNillableLastRunStatus sets the "last_run_status" field if the given value is not nil.
func (_c *TaskCreate) SetNillableLastRunStatus(v *string) *TaskCreate {
	if v != nil {
...
func (_c *TaskCreate) SetLastRunMessage(v string) *TaskCreate {
	_c.mutation.SetLastRunMessage(v)
	return _c
}

// SetNillableLastRunMessage sets the "last_run_message" field if the given value is not nil.
func (_c *TaskCreate) SetNillableLastRunMessage(v *string) *TaskCreate {
	if v != nil {
		_c.SetLastRunMessage(*v)
	}
	return _c
}

// SetRunCount sets the "run_count" field.
func (_c *TaskCreate) SetRunCount(v int32) *TaskCreate {
	_c.mutation.SetRunCount(v)
	return _c
}

// SetNillableRunCount sets the "run_count" field if the given value is not nil.
func (_c *TaskCreate) SetNillableRunCount(v *int32) *TaskCreate {
	if v != nil {
		_c.SetRunCount(*v)
	}
	return _c
...
func (_c *TaskCreate) check() error {
	...
	if _, ok := _c.mutation.RunCount(); !ok {
		return &ValidationError{Name: "run_count", err: errors.New(`ent: missing required field "Task.run_count"`)}
	}
...
func (_c *TaskCreate) createSpec() (*Task, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.ModuleID(); ok {
		_spec.SetField(task.FieldModuleID, field.TypeString, value)
	...
	if value, ok := _c.mutation.LastRunAt(); ok {
		_spec.SetField(task.FieldLastRunAt, field.TypeTime, value)
		_node.LastRunAt = &value
	}
	if value, ok := _c.mutation.LastRunStatus(); ok {
		_spec.SetField(task.FieldLastRunStatus, field.TypeString, value)
		_node.LastRunStatus = &value
	}
	if value, ok := _c.mutation.LastRunMessage(); ok {
		_spec.SetField(task.FieldLastRunMessage, field.TypeString, value)
		_node.LastRunMessage = &value
	}
	if value, ok := _c.mutation.RunCount(); ok {
		_spec.SetField(task.FieldRunCount, field.TypeInt32, value)
...
// SetModuleID sets the "module_id" field.
func (u *TaskUpsert) SetModuleID(v string) *TaskUpsert {
	u.Set(task.FieldModuleID, v)
	return u
}

// UpdateModuleID sets the "module_id" field to the value that was provided on create.
func (u *TaskUpsert) UpdateModuleID() *TaskUpsert {
	u.SetExcluded(task.FieldModuleID)
	return u
}

// ClearModuleID clears the value of the "module_id" field.
func (u *TaskUpsert) ClearModuleID() *TaskUpsert {
	u.SetNull(task.FieldModuleID)
	return u
}
...
// SetTaskOptions sets the "task_options" field.
func (u *TaskUpsert) SetTaskOptions(v *schedulerpb.TaskOption) *TaskUpsert {
...
// SetLastRunAt sets the "last_run_at" field.
func (u *TaskUpsert) SetLastRunAt(v time.Time) *TaskUpsert {
	u.Set(task.FieldLastRunAt, v)
	return u
}

// UpdateLastRunAt sets the "last_run_at" field to the value that was provided on create.
func (u *TaskUpsert) UpdateLastRunAt() *TaskUpsert {
	u.SetExcluded(task.FieldLastRunAt)
	return u
}

// ClearLastRunAt clears the value of the "last_run_at" field.
func (u *TaskUpsert) ClearLastRunAt() *TaskUpsert {
	u.SetNull(task.FieldLastRunAt)
	return u
}

// SetLastRunStatus sets the "last_run_status" field.
func (u *TaskUpsert) SetLastRunStatus(v string) *TaskUpsert {
	u.Set(task.FieldLastRunStatus, v)
	return u
}

// UpdateLastRunStatus sets the "last_run_status" field to the value that was provided on create.
func (u *TaskUpsert) UpdateLastRunStatus() *TaskUpsert {
	u.SetExcluded(task.FieldLastRunStatus)
	return u
}

// ClearLastRunStatus clears the value of the "last_run_status" field.
func (u *TaskUpsert) ClearLastRunStatus() *TaskUpsert {
	u.SetNull(task.FieldLastRunStatus)
	return u
}

// SetLastRunMessage sets the "last_run_message" field.
func (u *TaskUpsert) SetLastRunMessage(v string) *TaskUpsert {
	u.Set(task.FieldLastRunMessage, v)
	return u
}

// UpdateLastRunMessage sets the "last_run_message" field to the value that was provided on create.
func (u *TaskUpsert) UpdateLastRunMessage() *TaskUpsert {
	u.SetExcluded(task.FieldLastRunMessage)
	return u
}

// ClearLastRunMessage clears the value of the "last_run_message" field.
func (u *TaskUpsert) ClearLastRunMessage() *TaskUpsert {
	u.SetNull(task.FieldLastRunMessage)
	return u
}

// SetRunCount sets the "run_count" field.
func (u *TaskUpsert) SetRunCount(v int32) *TaskUpsert {
	u.Set(task.FieldRunCount, v)
	return u
}

// UpdateRunCount sets the "run_count" field to the value that was provided on create.
func (u *TaskUpsert) UpdateRunCount() *TaskUpsert {
	u.SetExcluded(task.FieldRunCount)
	return u
}

// AddRunCount adds v to the "run_count" field.
func (u *TaskUpsert) AddRunCount(v int32) *TaskUpsert {
	u.Add(task.FieldRunCount, v)
	return u
}
...
// SetModuleID sets the "module_id" field.
func (u *TaskUpsertOne) SetModuleID(v string) *TaskUpsertOne {
	return u.Update(func(s *TaskUpsert) {
		s.SetModuleID(v)
	})
}
...
// UpdateModuleID sets the "module_id" field to the value that was provided on create.
func (u *TaskUpsertOne) UpdateModuleID() *TaskUpsertOne {
	return u.Update(func(s *TaskUpsert) {
		s.UpdateModuleID()
	})
}
...
// ClearModuleID clears the value of the "module_id" field.
func (u *TaskUpsertOne) ClearModuleID() *TaskUpsertOne {
	return u.Update(func(s *TaskUpsert) {
		s.ClearModuleID()
	})
}
...
// SetTaskOptions sets the "task_options" field.
func (u *TaskUpsertOne) SetTaskOptions(v *schedulerpb.TaskOption) *TaskUpsertOne {
	return u.Update(func(s *TaskUpsert) {
		s.SetTaskOptions(v)
	})
}
...
// SetLastRunAt sets the "last_run_at" field.
func (u *TaskUpsertOne) SetLastRunAt(v time.Time) *TaskUpsertOne {
	return u.Update(func(s *TaskUpsert) {
		s.SetLastRunAt(v)
	})
}
...
// UpdateLastRunAt sets the "last_run_at" field to the value that was provided on create.
func (u *TaskUpsertOne) UpdateLastRunAt() *TaskUpsertOne {
	return u.Update(func(s *TaskUpsert) {
		s.UpdateLastRunAt()
	})
}
...
// ClearLastRunAt clears the value of the "last_run_at" field.
func (u *TaskUpsertOne) ClearLastRunAt() *TaskUpsertOne {
	return u.Update(func(s *TaskUpsert) {
		s.ClearLastRunAt()
	})
}
...
// SetLastRunStatus sets the "last_run_status" field.
func (u *TaskUpsertOne) SetLastRunStatus(v string) *TaskUpsertOne {
	return u.Update(func(s *TaskUpsert) {
...
// UpdateLastRunStatus sets the "last_run_status" field to the value that was provided on create.
func (u *TaskUpsertOne) UpdateLastRunStatus() *TaskUpsertOne {
	return u.Update(func(s *TaskUpsert) {
...
// ClearLastRunStatus clears the value of the "last_run_status" field.
func (u *TaskUpsertOne) ClearLastRunStatus() *TaskUpsertOne {
	return u.Update(func(s *TaskUpsert) {
...
// SetLastRunMessage sets the "last_run_message" field.
func (u *TaskUpsertOne) SetLastRunMessage(v string) *TaskUpsertOne {
	return u.Update(func(s *TaskUpsert) {
		s.SetLastRunMessage(v)
	})
}

// UpdateLastRunMessage sets the "last_run_message" field to the value that was provided on create.
func (u *TaskUpsertOne) UpdateLastRunMessage() *TaskUpsertOne {
	return u.Update(func(s *TaskUpsert) {
		s.UpdateLastRunMessage()
	})
}

// ClearLastRunMessage clears the value of the "last_run_message" field.
func (u *TaskUpsertOne) ClearLastRunMessage() *TaskUpsertOne {
	return u.Update(func(s *TaskUpsert) {
		s.ClearLastRunMessage()
	})
}

// SetRunCount sets the "run_count" field.
func (u *TaskUpsertOne) SetRunCount(v int32) *TaskUpsertOne {
	return u.Update(func(s *TaskUpsert) {
		s.SetRunCount(v)
	})
}
...
// AddRunCount adds v to the "run_count" field.
func (u *TaskUpsertOne) AddRunCount(v int32) *TaskUpsertOne {
	return u.Update(func(s *TaskUpsert) {
		s.AddRunCount(v)
	})
}
...
// UpdateRunCount sets the "run_count" field to the value that was provided on create.
func (u *TaskUpsertOne) UpdateRunCount() *TaskUpsertOne {
	return u.Update(func(s *TaskUpsert) {
		s.UpdateRunCount()
	})
}
...
// SetModuleID sets the "module_id" field.
func (u *TaskUpsertBulk) SetModuleID(v string) *TaskUpsertBulk {
	return u.Update(func(s *TaskUpsert) {
		s.SetModuleID(v)
	})
}
...
// UpdateModuleID sets the "module_id" field to the value that was provided on create.
func (u *TaskUpsertBulk) UpdateModuleID() *TaskUpsertBulk {
	return u.Update(func(s *TaskUpsert) {
		s.UpdateModuleID()
	})
}
...
// ClearModuleID clears the value of the "module_id" field.
func (u *TaskUpsertBulk) ClearModuleID() *TaskUpsertBulk {
	return u.Update(func(s *TaskUpsert) {
		s.ClearModuleID()
	})
}
...
// SetTaskOptions sets the "task_options" field.
func (u *TaskUpsertBulk) SetTaskOptions(v *schedulerpb.TaskOption) *TaskUpsertBulk {
	return u.Update(func(s *TaskUpsert) {
		s.SetTaskOptions(v)
	})
}
...
// SetLastRunAt sets the "last_run_at" field.
func (u *TaskUpsertBulk) SetLastRunAt(v time.Time) *TaskUpsertBulk {
	return u.Update(func(s *TaskUpsert) {
		s.SetLastRunAt(v)
	})
}
...
// UpdateLastRunAt sets the "last_run_at" field to the value that was provided on create.
func (u *TaskUpsertBulk) UpdateLastRunAt() *TaskUpsertBulk {
	return u.Update(func(s *TaskUpsert) {
		s.UpdateLastRunAt()
	})
}
...
// ClearLastRunAt clears the value of the "last_run_at" field.
func (u *TaskUpsertBulk) ClearLastRunAt() *TaskUpsertBulk {
	return u.Update(func(s *TaskUpsert) {
		s.ClearLastRunAt()
	})
}
...
// SetLastRunStatus sets the "last_run_status" field.
func (u *TaskUpsertBulk) SetLastRunStatus(v string) *TaskUpsertBulk {
	return u.Update(func(s *TaskUpsert) {
		s.SetLastRunStatus(v)
	})
}
...
// UpdateLastRunStatus sets the "last_run_status" field to the value that was provided on create.
func (u *TaskUpsertBulk) UpdateLastRunStatus() *TaskUpsertBulk {
	return u.Update(func(s *TaskUpsert) {
		s.UpdateLastRunStatus()
	})
}
...
// ClearLastRunStatus clears the value of the "last_run_status" field.
func (u *TaskUpsertBulk) ClearLastRunStatus() *TaskUpsertBulk {
	return u.Update(func(s *TaskUpsert) {
		s.ClearLastRunStatus()
	})
}
...
// SetLastRunMessage sets the "last_run_message" field.
func (u *TaskUpsertBulk) SetLastRunMessage(v string) *TaskUpsertBulk {
	return u.Update(func(s *TaskUpsert) {
		s.SetLastRunMessage(v)
	})
}
...
// UpdateLastRunMessage sets the "last_run_message" field to the value that was provided on create.
func (u *TaskUpsertBulk) UpdateLastRunMessage() *TaskUpsertBulk {
	return u.Update(func(s *TaskUpsert) {
		s.UpdateLastRunMessage()
	})
}
...
// ClearLastRunMessage clears the value of the "last_run_message" field.
func (u *TaskUpsertBulk) ClearLastRunMessage() *TaskUpsertBulk {
	return u.Update(func(s *TaskUpsert) {
		s.ClearLastRunMessage()
	})
}
...
// SetRunCount sets the "run_count" field.
func (u *TaskUpsertBulk) SetRunCount(v int32) *TaskUpsertBulk {
	return u.Update(func(s *TaskUpsert) {
		s.SetRunCount(v)
	})
}
...
// AddRunCount adds v to the "run_count" field.
func (u *TaskUpsertBulk) AddRunCount(v int32) *TaskUpsertBulk {
	return u.Update(func(s *TaskUpsert) {
		s.AddRunCount(v)
	})
}
...
// UpdateRunCount sets the "run_count" field to the value that was provided on create.
func (u *TaskUpsertBulk) UpdateRunCount() *TaskUpsertBulk {
	return u.Update(func(s *TaskUpsert) {
		s.UpdateRunCount()
	})
}

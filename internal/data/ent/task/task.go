...
const (
	...
	// FieldLastRunMessage holds the string denoting the last_run_message field in the database.
	FieldLastRunMessage = "last_run_message"
...
//
//	import _ "github.com/go-tangra/go-tangra-scheduler/internal/data/ent/runtime"
var (
	Hooks  [1]ent.Hook
	Policy ent.Policy
...
// ByLastRunMessage orders the results by the last_run_message field.
func ByLastRunMessage(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldLastRunMessage, opts...).ToFunc()
}

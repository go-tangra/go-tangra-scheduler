...
func ModuleID(v string) predicate.Task {
	return predicate.Task(sql.FieldEQ(FieldModuleID, v))
}
...
func LastRunAt(v time.Time) predicate.Task {
	return predicate.Task(sql.FieldEQ(FieldLastRunAt, v))
}

// LastRunStatus applies equality check predicate on the "last_run_status" field. It's identical to LastRunStatusEQ.
func LastRunStatus(v string) predicate.Task {
	return predicate.Task(sql.FieldEQ(FieldLastRunStatus, v))
}

// LastRunMessage applies equality check predicate on the "last_run_message" field. It's identical to LastRunMessageEQ.
func LastRunMessage(v string) predicate.Task {
	return predicate.Task(sql.FieldEQ(FieldLastRunMessage, v))
}

// RunCount applies equality check predicate on the "run_count" field. It's identical to RunCountEQ.
func RunCount(v int32) predicate.Task {
	return predicate.Task(sql.FieldEQ(FieldRunCount, v))
}
...
func ModuleIDEQ(v string) predicate.Task {
	return predicate.Task(sql.FieldEQ(FieldModuleID, v))
}

// ModuleIDNEQ applies the NEQ predicate on the "module_id" field.
func ModuleIDNEQ(v string) predicate.Task {
	return predicate.Task(sql.FieldNEQ(FieldModuleID, v))
}

// ModuleIDIn applies the In predicate on the "module_id" field.
func ModuleIDIn(vs ...string) predicate.Task {
	return predicate.Task(sql.FieldIn(FieldModuleID, vs...))
}

// ModuleIDNotIn applies the NotIn predicate on the "module_id" field.
func ModuleIDNotIn(vs ...string) predicate.Task {
	return predicate.Task(sql.FieldNotIn(FieldModuleID, vs...))
}

// ModuleIDGT applies the GT predicate on the "module_id" field.
func ModuleIDGT(v string) predicate.Task {
	return predicate.Task(sql.FieldGT(FieldModuleID, v))
}

// ModuleIDGTE applies the GTE predicate on the "module_id" field.
func ModuleIDGTE(v string) predicate.Task {
	return predicate.Task(sql.FieldGTE(FieldModuleID, v))
}

// ModuleIDLT applies the LT predicate on the "module_id" field.
func ModuleIDLT(v string) predicate.Task {
	return predicate.Task(sql.FieldLT(FieldModuleID, v))
}

// ModuleIDLTE applies the LTE predicate on the "module_id" field.
func ModuleIDLTE(v string) predicate.Task {
	return predicate.Task(sql.FieldLTE(FieldModuleID, v))
}

// ModuleIDContains applies the Contains predicate on the "module_id" field.
func ModuleIDContains(v string) predicate.Task {
	return predicate.Task(sql.FieldContains(FieldModuleID, v))
}

// ModuleIDHasPrefix applies the HasPrefix predicate on the "module_id" field.
func ModuleIDHasPrefix(v string) predicate.Task {
	return predicate.Task(sql.FieldHasPrefix(FieldModuleID, v))
}

// ModuleIDHasSuffix applies the HasSuffix predicate on the "module_id" field.
func ModuleIDHasSuffix(v string) predicate.Task {
	return predicate.Task(sql.FieldHasSuffix(FieldModuleID, v))
}

// ModuleIDIsNil applies the IsNil predicate on the "module_id" field.
func ModuleIDIsNil() predicate.Task {
	return predicate.Task(sql.FieldIsNull(FieldModuleID))
}

// ModuleIDNotNil applies the NotNil predicate on the "module_id" field.
func ModuleIDNotNil() predicate.Task {
	return predicate.Task(sql.FieldNotNull(FieldModuleID))
}

// ModuleIDEqualFold applies the EqualFold predicate on the "module_id" field.
func ModuleIDEqualFold(v string) predicate.Task {
	return predicate.Task(sql.FieldEqualFold(FieldModuleID, v))
}

// ModuleIDContainsFold applies the ContainsFold predicate on the "module_id" field.
func ModuleIDContainsFold(v string) predicate.Task {
	return predicate.Task(sql.FieldContainsFold(FieldModuleID, v))
}
...
func LastRunAtEQ(v time.Time) predicate.Task {
	return predicate.Task(sql.FieldEQ(FieldLastRunAt, v))
}

// LastRunAtNEQ applies the NEQ predicate on the "last_run_at" field.
func LastRunAtNEQ(v time.Time) predicate.Task {
	return predicate.Task(sql.FieldNEQ(FieldLastRunAt, v))
}

// LastRunAtIn applies the In predicate on the "last_run_at" field.
func LastRunAtIn(vs ...time.Time) predicate.Task {
	return predicate.Task(sql.FieldIn(FieldLastRunAt, vs...))
}

// LastRunAtNotIn applies the NotIn predicate on the "last_run_at" field.
func LastRunAtNotIn(vs ...time.Time) predicate.Task {
	return predicate.Task(sql.FieldNotIn(FieldLastRunAt, vs...))
}

// LastRunAtGT applies the GT predicate on the "last_run_at" field.
func LastRunAtGT(v time.Time) predicate.Task {
	return predicate.Task(sql.FieldGT(FieldLastRunAt, v))
}

// LastRunAtGTE applies the GTE predicate on the "last_run_at" field.
func LastRunAtGTE(v time.Time) predicate.Task {
	return predicate.Task(sql.FieldGTE(FieldLastRunAt, v))
}

// LastRunAtLT applies the LT predicate on the "last_run_at" field.
func LastRunAtLT(v time.Time) predicate.Task {
	return predicate.Task(sql.FieldLT(FieldLastRunAt, v))
}

// LastRunAtLTE applies the LTE predicate on the "last_run_at" field.
func LastRunAtLTE(v time.Time) predicate.Task {
	return predicate.Task(sql.FieldLTE(FieldLastRunAt, v))
}

// LastRunAtIsNil applies the IsNil predicate on the "last_run_at" field.
func LastRunAtIsNil() predicate.Task {
	return predicate.Task(sql.FieldIsNull(FieldLastRunAt))
}

// LastRunAtNotNil applies the NotNil predicate on the "last_run_at" field.
func LastRunAtNotNil() predicate.Task {
	return predicate.Task(sql.FieldNotNull(FieldLastRunAt))
}

// LastRunStatusEQ applies the EQ predicate on the "last_run_status" field.
func LastRunStatusEQ(v string) predicate.Task {
	return predicate.Task(sql.FieldEQ(FieldLastRunStatus, v))
}

// LastRunStatusNEQ applies the NEQ predicate on the "last_run_status" field.
func LastRunStatusNEQ(v string) predicate.Task {
	return predicate.Task(sql.FieldNEQ(FieldLastRunStatus, v))
}

// LastRunStatusIn applies the In predicate on the "last_run_status" field.
func LastRunStatusIn(vs ...string) predicate.Task {
	return predicate.Task(sql.FieldIn(FieldLastRunStatus, vs...))
}

// LastRunStatusNotIn applies the NotIn predicate on the "last_run_status" field.
func LastRunStatusNotIn(vs ...string) predicate.Task {
	return predicate.Task(sql.FieldNotIn(FieldLastRunStatus, vs...))
}

// LastRunStatusGT applies the GT predicate on the "last_run_status" field.
func LastRunStatusGT(v string) predicate.Task {
	return predicate.Task(sql.FieldGT(FieldLastRunStatus, v))
}

// LastRunStatusGTE applies the GTE predicate on the "last_run_status" field.
func LastRunStatusGTE(v string) predicate.Task {
	return predicate.Task(sql.FieldGTE(FieldLastRunStatus, v))
}

// LastRunStatusLT applies the LT predicate on the "last_run_status" field.
func LastRunStatusLT(v string) predicate.Task {
	return predicate.Task(sql.FieldLT(FieldLastRunStatus, v))
}

// LastRunStatusLTE applies the LTE predicate on the "last_run_status" field.
func LastRunStatusLTE(v string) predicate.Task {
	return predicate.Task(sql.FieldLTE(FieldLastRunStatus, v))
}

// LastRunStatusContains applies the Contains predicate on the "last_run_status" field.
func LastRunStatusContains(v string) predicate.Task {
	return predicate.Task(sql.FieldContains(FieldLastRunStatus, v))
}

// LastRunStatusHasPrefix applies the HasPrefix predicate on the "last_run_status" field.
func LastRunStatusHasPrefix(v string) predicate.Task {
	return predicate.Task(sql.FieldHasPrefix(FieldLastRunStatus, v))
}

// LastRunStatusHasSuffix applies the HasSuffix predicate on the "last_run_status" field.
func LastRunStatusHasSuffix(v string) predicate.Task {
	return predicate.Task(sql.FieldHasSuffix(FieldLastRunStatus, v))
}

// LastRunStatusIsNil applies the IsNil predicate on the "last_run_status" field.
func LastRunStatusIsNil() predicate.Task {
	return predicate.Task(sql.FieldIsNull(FieldLastRunStatus))
}

// LastRunStatusNotNil applies the NotNil predicate on the "last_run_status" field.
func LastRunStatusNotNil() predicate.Task {
	return predicate.Task(sql.FieldNotNull(FieldLastRunStatus))
}

// LastRunStatusEqualFold applies the EqualFold predicate on the "last_run_status" field.
func LastRunStatusEqualFold(v string) predicate.Task {
	return predicate.Task(sql.FieldEqualFold(FieldLastRunStatus, v))
}

// LastRunStatusContainsFold applies the ContainsFold predicate on the "last_run_status" field.
func LastRunStatusContainsFold(v string) predicate.Task {
	return predicate.Task(sql.FieldContainsFold(FieldLastRunStatus, v))
}

// LastRunMessageEQ applies the EQ predicate on the "last_run_message" field.
func LastRunMessageEQ(v string) predicate.Task {
	return predicate.Task(sql.FieldEQ(FieldLastRunMessage, v))
}

// LastRunMessageNEQ applies the NEQ predicate on the "last_run_message" field.
func LastRunMessageNEQ(v string) predicate.Task {
	return predicate.Task(sql.FieldNEQ(FieldLastRunMessage, v))
}

// LastRunMessageIn applies the In predicate on the "last_run_message" field.
func LastRunMessageIn(vs ...string) predicate.Task {
	return predicate.Task(sql.FieldIn(FieldLastRunMessage, vs...))
}

// LastRunMessageNotIn applies the NotIn predicate on the "last_run_message" field.
func LastRunMessageNotIn(vs ...string) predicate.Task {
	return predicate.Task(sql.FieldNotIn(FieldLastRunMessage, vs...))
}

// LastRunMessageGT applies the GT predicate on the "last_run_message" field.
func LastRunMessageGT(v string) predicate.Task {
	return predicate.Task(sql.FieldGT(FieldLastRunMessage, v))
}

// LastRunMessageGTE applies the GTE predicate on the "last_run_message" field.
func LastRunMessageGTE(v string) predicate.Task {
	return predicate.Task(sql.FieldGTE(FieldLastRunMessage, v))
}

// LastRunMessageLT applies the LT predicate on the "last_run_message" field.
func LastRunMessageLT(v string) predicate.Task {
	return predicate.Task(sql.FieldLT(FieldLastRunMessage, v))
}

// LastRunMessageLTE applies the LTE predicate on the "last_run_message" field.
func LastRunMessageLTE(v string) predicate.Task {
	return predicate.Task(sql.FieldLTE(FieldLastRunMessage, v))
}

// LastRunMessageContains applies the Contains predicate on the "last_run_message" field.
func LastRunMessageContains(v string) predicate.Task {
	return predicate.Task(sql.FieldContains(FieldLastRunMessage, v))
}

// LastRunMessageHasPrefix applies the HasPrefix predicate on the "last_run_message" field.
func LastRunMessageHasPrefix(v string) predicate.Task {
	return predicate.Task(sql.FieldHasPrefix(FieldLastRunMessage, v))
}

// LastRunMessageHasSuffix applies the HasSuffix predicate on the "last_run_message" field.
func LastRunMessageHasSuffix(v string) predicate.Task {
	return predicate.Task(sql.FieldHasSuffix(FieldLastRunMessage, v))
}

// LastRunMessageIsNil applies the IsNil predicate on the "last_run_message" field.
func LastRunMessageIsNil() predicate.Task {
	return predicate.Task(sql.FieldIsNull(FieldLastRunMessage))
}

// LastRunMessageNotNil applies the NotNil predicate on the "last_run_message" field.
func LastRunMessageNotNil() predicate.Task {
	return predicate.Task(sql.FieldNotNull(FieldLastRunMessage))
}

// LastRunMessageEqualFold applies the EqualFold predicate on the "last_run_message" field.
func LastRunMessageEqualFold(v string) predicate.Task {
	return predicate.Task(sql.FieldEqualFold(FieldLastRunMessage, v))
}

// LastRunMessageContainsFold applies the ContainsFold predicate on the "last_run_message" field.
func LastRunMessageContainsFold(v string) predicate.Task {
	return predicate.Task(sql.FieldContainsFold(FieldLastRunMessage, v))
}

// RunCountEQ applies the EQ predicate on the "run_count" field.
func RunCountEQ(v int32) predicate.Task {
	return predicate.Task(sql.FieldEQ(FieldRunCount, v))
}

// RunCountNEQ applies the NEQ predicate on the "run_count" field.
func RunCountNEQ(v int32) predicate.Task {
	return predicate.Task(sql.FieldNEQ(FieldRunCount, v))
}

// RunCountIn applies the In predicate on the "run_count" field.
func RunCountIn(vs ...int32) predicate.Task {
	return predicate.Task(sql.FieldIn(FieldRunCount, vs...))
}

// RunCountNotIn applies the NotIn predicate on the "run_count" field.
func RunCountNotIn(vs ...int32) predicate.Task {
	return predicate.Task(sql.FieldNotIn(FieldRunCount, vs...))
}

// RunCountGT applies the GT predicate on the "run_count" field.
func RunCountGT(v int32) predicate.Task {
	return predicate.Task(sql.FieldGT(FieldRunCount, v))
}

// RunCountGTE applies the GTE predicate on the "run_count" field.
func RunCountGTE(v int32) predicate.Task {
	return predicate.Task(sql.FieldGTE(FieldRunCount, v))
}

// RunCountLT applies the LT predicate on the "run_count" field.
func RunCountLT(v int32) predicate.Task {
	return predicate.Task(sql.FieldLT(FieldRunCount, v))
}

// RunCountLTE applies the LTE predicate on the "run_count" field.
func RunCountLTE(v int32) predicate.Task {
	return predicate.Task(sql.FieldLTE(FieldRunCount, v))
}

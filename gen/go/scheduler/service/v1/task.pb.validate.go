...
func (m *Task) validate(all bool) error {
	...
	if m.LastRunMessage != nil {
		// no validation rules for LastRunMessage
	}
...
// Validate checks the field values on RestartAllTasksResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *RestartAllTasksResponse) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on RestartAllTasksResponse with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// RestartAllTasksResponseMultiError, or nil if none found.
func (m *RestartAllTasksResponse) ValidateAll() error {
	return m.validate(true)
}

func (m *RestartAllTasksResponse) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return RestartAllTasksResponseMultiError(errors)
	}

	return nil
}

// RestartAllTasksResponseMultiError is an error wrapping multiple validation
// errors returned by RestartAllTasksResponse.ValidateAll() if the designated
// constraints aren't met.
type RestartAllTasksResponseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m RestartAllTasksResponseMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m RestartAllTasksResponseMultiError) AllErrors() []error { return m }

// RestartAllTasksResponseValidationError is the validation error returned by
// RestartAllTasksResponse.Validate if the designated constraints aren't met.
type RestartAllTasksResponseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e RestartAllTasksResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e RestartAllTasksResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e RestartAllTasksResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e RestartAllTasksResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e RestartAllTasksResponseValidationError) ErrorName() string {
	return "RestartAllTasksResponseValidationError"
}

// Error satisfies the builtin error interface
func (e RestartAllTasksResponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sRestartAllTasksResponse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = RestartAllTasksResponseValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = RestartAllTasksResponseValidationError{}
...
// Validate checks the field values on ListTaskTypeNamesResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *ListTaskTypeNamesResponse) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on ListTaskTypeNamesResponse with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// ListTaskTypeNamesResponseMultiError, or nil if none found.
func (m *ListTaskTypeNamesResponse) ValidateAll() error {
	return m.validate(true)
}

func (m *ListTaskTypeNamesResponse) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return ListTaskTypeNamesResponseMultiError(errors)
	}

	return nil
}

// ListTaskTypeNamesResponseMultiError is an error wrapping multiple validation
// errors returned by ListTaskTypeNamesResponse.ValidateAll() if the
// designated constraints aren't met.
type ListTaskTypeNamesResponseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m ListTaskTypeNamesResponseMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m ListTaskTypeNamesResponseMultiError) AllErrors() []error { return m }

// ListTaskTypeNamesResponseValidationError is the validation error returned by
// ListTaskTypeNamesResponse.Validate if the designated constraints aren't met.
type ListTaskTypeNamesResponseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e ListTaskTypeNamesResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e ListTaskTypeNamesResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e ListTaskTypeNamesResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e ListTaskTypeNamesResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e ListTaskTypeNamesResponseValidationError) ErrorName() string {
	return "ListTaskTypeNamesResponseValidationError"
}

// Error satisfies the builtin error interface
func (e ListTaskTypeNamesResponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sListTaskTypeNamesResponse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = ListTaskTypeNamesResponseValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = ListTaskTypeNamesResponseValidationError{}

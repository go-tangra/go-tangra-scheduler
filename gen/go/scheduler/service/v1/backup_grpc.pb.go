...
const (
	BackupService_ExportBackup_FullMethodName = "/scheduler.service.v1.BackupService/ExportBackup"
	BackupService_ImportBackup_FullMethodName = "/scheduler.service.v1.BackupService/ImportBackup"
)
...
var BackupService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "scheduler.service.v1.BackupService",
	...
	Metadata: "scheduler/service/v1/backup.proto",
}
